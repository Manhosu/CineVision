# 🚨 URGENTE: Executar Migração da Tabela Payments

## Problema Atual

O bot está funcionando, mas **pagamentos PIX estão falhando** com o erro:
...
**Causa:** A tabela `payments` não existe no Supabase.
...
3. Selecione o projeto **CineVision**
4. Menu lateral esquerdo → **SQL Editor**
5. Clique: **New Query**
...
**COPIE TODO o conteúdo do arquivo:** [MIGRACAO-COMPLETA-FINAL.sql](MIGRACAO-COMPLETA-FINAL.sql)
...
E uma **tabela mostrando a estrutura** da tabela `payments`.
...
Se der algum erro, envie print da mensagem de erro completa.
