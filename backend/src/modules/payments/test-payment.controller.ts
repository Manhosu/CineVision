  ...
  async simulatePaymentSuccess(@Param('purchaseId') purchaseId: string) {
    try {
      ...
      return {
        ...
        test_url: `https://telegram.me/CineVisionApp_rbot?start=payment_success_${purchase.id}`,
        notes: [
  ...
  async simulatePaymentCancel(@Param('purchaseId') purchaseId: string) {
    try {
      ...
      return {
        ...
        purchase_id: purchase.id,
        test_url: `https://telegram.me/CineVisionApp_rbot?start=payment_cancel_${purchase.id}`,
        notes: [
