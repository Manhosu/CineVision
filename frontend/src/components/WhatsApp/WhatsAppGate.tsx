      ...
      <AnimatePresence>
        ...
        >
          <motion.div
            ...
            className="bg-[#1a1a2e] border border-gray-700/50 rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden"
          >
            {/* Green header bar */}
            ...
            <div className="p-8">
              ...
              <div className="flex flex-col items-center text-center mb-6">
                <div className="w-20 h-20 bg-[#25D366] rounded-full flex items-center justify-center shadow-xl shadow-[#25D366]/30 mb-4">
              ...
              {/* Benefits */}
              <div className="bg-[#12122a] rounded-xl p-5 mb-6 space-y-3">
                <h3 className="text-[#25D366] font-semibold text-sm uppercase tracking-wide mb-3">
                  Beneficios do grupo
                </h3>
                {[
