            ...
            <div className="bg-[#1a1a2e] border border-gray-700/50 rounded-2xl shadow-2xl max-w-md w-full pointer-events-auto relative overflow-hidden">
              ...
              <div className="p-6 pt-5">
                ...
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-white">Grupo Exclusivo</h2>
                    <p className="text-[#25D366] text-sm font-medium">WhatsApp Cine Vision</p>
                  </div>
                </div>

                {/* Description */}
                <p className="text-gray-300 text-sm mb-5 leading-relaxed">
                  Entre no nosso grupo exclusivo do WhatsApp e tenha acesso a vantagens incriveis!
                </p>
                ...
                <div className="space-y-3 mb-6">
                  {[
                    ...
                    { icon: '💰', text: 'Promocoes exclusivas para membros' },
                    { icon: '🎁', text: 'Conteudos exclusivos e sorteios' },
                    { icon: '📢', text: 'Novidades e atualizacoes da plataforma' },
                  ].map((benefit, i) => (
