...
export default function DashboardPage() {
  ...
  // Igor (15/05): número salvo via gate aparece no header na hora, sem reload.
  ...
  return (
    <div className="min-h-screen bg-dark-950">
      ...
      <WhatsAppNumberGate
        ...
        onSaved={(digits) => setLocalWhatsapp(digits)}
      >
      ...
      <div className="container mx-auto px-4 lg:px-6 py-8 sm:py-12 mt-16 sm:mt-20">
        ...
        <div className="mb-8 bg-gradient-to-r from-red-900/20 to-purple-900/20 rounded-xl p-6 border border-red-500/20">
          ...
          <div className="flex flex-col gap-2">
            ...
            {/* Igor (15/05): exibe o WhatsApp validado no topo, com selo verde. */}
            {(localWhatsapp || (user as any).whatsapp) && (
              <div className="inline-flex items-center gap-2 mt-1 px-3 py-1.5 rounded-lg bg-[#25D366]/15 border border-[#25D366]/30 w-fit">
                ...
                <span className="text-[#25D366] font-medium text-xs sm:text-sm">
                  WhatsApp validado: {localWhatsapp || (user as any).whatsapp}
                </span>
              </div>
            )}
          </div>
