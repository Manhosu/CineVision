                  ...
                  <div className="space-y-4 tv:space-y-6">
                    ...
                    <div>
                      ...
                      <dd className="flex gap-2 tv:gap-3">
                        {series.quality_label ? (
                          <span className={`px-2 py-1 tv:px-3 tv:py-2 text-xs tv:text-sm font-bold rounded ${
                            series.quality_label === 'HD CAM' ? 'bg-yellow-600/20 border border-yellow-600/30 text-yellow-400' :
                            series.quality_label === 'CINEMA' ? 'bg-purple-600/20 border border-purple-600/30 text-purple-400' :
                            series.quality_label === 'FULL HD' ? 'bg-blue-600/20 border border-blue-600/30 text-blue-400' :
                            series.quality_label === 'EXCLUSIVA' ? 'bg-red-600/20 border border-red-600/30 text-red-400' :
