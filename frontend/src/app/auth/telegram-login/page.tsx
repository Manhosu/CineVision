  ...
  useEffect(() => {
    const handleTelegramLogin = async () => {
      try {
        ...
        if (!telegramId) {
          setStatus('error');
          setErrorMessage('ID do Telegram não fornecido');
          return;
        }

        // Chamar endpoint de telegram-login
        ...
        console.error('Erro no telegram-login:', error);
        setStatus('error');
        setErrorMessage(error.message || 'Erro ao realizar autenticação com Telegram');
