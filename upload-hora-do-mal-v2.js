...
// IDs dos idiomas (DUBLADO já existe)
const LANGUAGE_IDS = {
  DUBLADO: 'c5ab0f45-0cf6-410a-8dd7-eeccd0917285',
  LEGENDADO: null // Será criado
};
...
const FILES = [
  {
    ...
    languageId: LANGUAGE_IDS.DUBLADO
  },
  {
    ...
    languageId: LANGUAGE_IDS.LEGENDADO
  }
];
...
async function uploadFile(fileInfo) {
  ...
  let languageId = fileInfo.languageId;

  // 1. Criar registro de language se não existir
  if (!languageId) {
    ...
    console.log(`✅ Idioma criado - ID: ${languageId}`);
  } else {
    console.log(`✅ Usando idioma existente - ID: ${languageId}`);
  }
